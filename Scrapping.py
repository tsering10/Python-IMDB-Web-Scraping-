...
class FilmList:
  ...
  def download_html(self):
    ...
    for month in range(1, 13):
      ...
      f = open('/Users/tashitsering/Desktop/Simplon-DD2-IMDB-MongoDB/data/film_lists/{:04d}-{:02d}'.format(self.year,month), 'w')
      f.write(str(soup))
      f.close()
  ...
  def get_films_ids(self):
    ...
    for month in range(1,13):
      f = open('/Users/tashitsering/Desktop/Simplon-DD2-IMDB-MongoDB/data/film_lists/{:04d}-{:02d}'.format(self.year,month), 'r')
...
class Film:
  ...
  def __init__(self, id):
    self.url = 'https://www.imdb.com/title/' + str(id)
    self.id = id
  ...
  def download_html(self):
    ...
    f = open('/Users/tashitsering/Desktop/Simplon-DD2-IMDB-MongoDB/data/films/{}'.format(self.id), 'w')
    f.write(str(soup))
    f.close()
  ...
  def download_actors_html(self):
    ...
    f = open('/Users/tashitsering/Desktop/Simplon-DD2-IMDB-MongoDB/data/actors/{}'.format(self.id), 'w')
    f.write(str(soup))
    f.close()
  ...
  def scrap(self):
    f = open('/Users/tashitsering/Desktop/Simplon-DD2-IMDB-MongoDB/data/films/{}'.format(self.id), 'r')
    soup = BeautifulSoup(f, 'html.parser')
  ...
  def get_actors(self):
    ...
    f = open('/Users/tashitsering/Desktop/Simplon-DD2-IMDB-MongoDB/data/actors/{}'.format(self.id), 'r')
    soup = BeautifulSoup(f, 'html.parser')
  ...
  def get_data(self, actors, amount):
